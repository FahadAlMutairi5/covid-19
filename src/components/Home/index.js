...
class index extends React.Component {
  ...
  render() {
    let { fullData } =  this.props.reports
        ...
        <div className="form-group col-lg-8 col-12 mx-auto my-5 text-right text-center">
            ...
            <div className="text-center text-muted mt-5">
                ...
                <br/><a href="https://covid19.moh.gov.sa/" target="_blank"> covid 19 </a>     
                <br/> 
                بالتعاون مع APIFY 
                <br/><a href="https://apify.com/covid-19" target="_blank"> APIFY </a>       
                <br/> من تصميم المبرمج : فهد المطيري
                <br/><a href="https://github.com/FahadAlMutairi5" target="_blank">Github</a>    
            </div>
        </div>
        );  
  }
